...
OPENAI_API_KEY=[ROTATED — generate new key at platform.openai.com]
OPENWEATHERMAP_API_KEY=[ROTATED — generate new key at openweathermap.org]
ANTHROPIC_API_KEY=[ROTATED — generate new key at console.anthropic.com]
