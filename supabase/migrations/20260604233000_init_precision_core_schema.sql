...
-- =====================================================================
-- Applied automatically by Supabase Branching (supabase/migrations).
-- Idempotent: safe on an empty preview branch and on a production DB
-- that already has some objects (e.g. profiles/users from Auth).
--
