          ...
          <div className="mb-6">
            <GanttChart
              ...
              weatherForecast={
                weather?.forecast?.[0]
                  ? {
                      ...
                      condition: weather.forecast[0].willRain
                        ? "rainy"
                        : "clear",
                      temperature: weather.forecast[0].tempHigh,
                      precipitation: weather.forecast[0].rainMm,
                    }
                  : undefined
              }
              readOnly={false}
              onTaskUpdate={(taskId, startDate, endDate) => {
                console.log(
                  `Task ${taskId} rescheduled to ${startDate} - ${endDate}`
                );
