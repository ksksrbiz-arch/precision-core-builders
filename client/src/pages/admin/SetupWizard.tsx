...
const SERVICES: ServiceKey[] = [
  ...
  {
    id: "weather",
    label: "Weather (Open-Meteo free or OpenWeatherMap)",
    envKey: "OPENWEATHERMAP_API_KEY",
    icon: CloudRain,
    description:
      "Eugene OR forecast for smart scheduling. Open-Meteo (free, no key) is used automatically when this is blank.",
    optional: true,
    guideSteps: [],
    guideUrl: "",
    urlLabel: "",
    placeholder: "Optional — leave blank for free Open-Meteo",
    prefix: "",
  },
  {
    id: "free_payments",
    label: "Free Payment Links (PayPal/Venmo/Zelle)",
    envKey: "VITE_PAYPAL_ME_USERNAME",
    icon: Zap,
    description:
      "Recommended free billing. Set any combination of PayPal.me / Venmo / Zelle handles to send clients payment links with zero fees and zero API setup.",
    optional: false,
    guideSteps: [
      "Open PayPal (or skip if you prefer Venmo/Zelle) and visit https://www.paypal.com/paypalme to claim your PayPal.me handle.",
      "Copy just the username portion (the part after paypal.me/) and paste it as VITE_PAYPAL_ME_USERNAME below.",
      "Optionally repeat for Venmo (your Venmo username) and Zelle (the email or phone tied to your Zelle account).",
      "Set VITE_INVOICE_FROM_EMAIL to your business email so client invoice emails CC you automatically.",
      "Done. Billing → New Invoice will default to Free Link mode and produce a copyable payment URL instantly.",
    ],
    guideUrl: "https://www.paypal.com/paypalme",
    urlLabel: "Claim PayPal.me handle",
    placeholder: "your-paypal-handle",
    prefix: "",
  },
  {
    id: "stripe",
    label: "Stripe Payments (Optional)",
    envKey: "STRIPE_SECRET_KEY",
    icon: CreditCard,
    description:
      "Optional. Only needed if you want to accept credit cards directly on the site. Free payment links above work without it.",
    optional: true,
    guideSteps: [
      ...
      "Also set VITE_FEATURE_STRIPE=true to surface the Stripe buttons in BillingView.",
    ],
